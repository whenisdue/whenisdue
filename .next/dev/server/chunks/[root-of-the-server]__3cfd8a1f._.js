...
"[project]/Desktop/whenisdue/web/app/api/agent/token/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!client_id || !client_secret || VALID_AGENTS[client_id] !== client_secret) {
        ...
        const jwt = await new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"]({
            scope: 'feed:financial_schedule',
            plan: 'pro'
        }).setProtectedHeader({
            alg: 'HS256',
            typ: 'JWT'
        }).setIssuer('urn:whenisdue:issuer').setSubject(client_id).setAudience('urn:whenisdue:api').setIssuedAt().setExpirationTime('10m') // Dies in exactly 10 minutes
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3cfd8a1f._.js.map