...
"[project]/Desktop/whenisdue/web/app/series/[seriesKey]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
// --- Cryptographic Helper for Web Push ---
// The browser's PushManager requires the VAPID public key to be converted into a Uint8Array.
...
function SeriesPage({ params }) {
    ...
    // State to manage button UI
    const [subStatus, setSubStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('idle');
    // --- The Core Web Push Subscription Logic ---
    const handleSubscribe = async ()=>{
        setSubStatus('loading');
        try {
            // 1. Check if the browser supports Service Workers and Web Push
            if (!('serviceWorker' in navigator) || !('PushManager' in window)) {
                alert('Web Push is not supported in this browser. Try Chrome or Safari.');
                setSubStatus('error');
                return;
            }
            // 2. Register the background listener (sw.js)
            const registration = await navigator.serviceWorker.register('/sw.js');
            await navigator.serviceWorker.ready;
            // 3. Grab the VAPID key from our .env.local file
            const vapidPublicKey = ("TURBOPACK compile-time value", "BJOn-I-W8u5T7QADc0l_z_vHmKeNZS7JROl9SfRrTjIvjzGu-p4gbH9WF7Jczwycmx9Exa41NQqGba_tHQ1Vm8Y");
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            // 4. Request permission & generate the cryptographic subscription
            const subscription = await registration.pushManager.subscribe({
                userVisibleOnly: true,
                applicationServerKey: urlBase64ToUint8Array(vapidPublicKey)
            });
            // 5. Send the encrypted routing data to our SQLite database via the API
            ...
            if (!response.ok) {
                throw new Error('Server rejected the subscription payload.');
            }
            setSubStatus('success');
            console.log("Successfully securely saved to SQLite Database!");
        } catch (error) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        style: {
                            backgroundColor: subStatus === 'success' ? '#10b981' : 'white',
                            color: subStatus === 'success' ? 'white' : '#1e3a8a',
                            padding: '10px 30px',
                            borderRadius: '50px',
                            border: 'none',
                            fontWeight: 'bold',
                            cursor: subStatus === 'success' ? 'default' : 'pointer',
                            transition: 'all 0.3s ease'
                        },
                        children: [
                            subStatus === 'idle' && "NOTIFY ME",
                            subStatus === 'loading' && "SECURING CONNECTION...",
                            subStatus === 'success' && "✓ SUBSCRIBED",
                            subStatus === 'error' && "ERROR - TRY AGAIN"
                        ]
                    }, void 0, true, {
                        fileName: "[project]/Desktop/whenisdue/web/app/series/[seriesKey]/page.tsx",
                        lineNumber: 108,
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "p-4 text-right",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "inline-block bg-blue-600 text-white text-[10px] font-black py-2 px-4 rounded uppercase tracking-widest",
...
_s(SeriesPage, "AVOFGzp0/1RBhIvR328zBDUrPN4=");
_c = SeriesPage;
var _c;
...
//# sourceMappingURL=Desktop_whenisdue_web_53e19531._.js.map