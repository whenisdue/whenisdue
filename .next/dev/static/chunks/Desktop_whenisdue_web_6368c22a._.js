...
"[project]/Desktop/whenisdue/web/app/verify/mirrors/useMirrorsData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMirrorsData() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMirrorsData.useEffect": ()=>{
            let isMounted = true;
            const load = {
                "useMirrorsData.useEffect.load": async ()=>{
                    try {
                        setState({
                            kind: "LOADING",
                        ...
                        const [dirRes, sthRes, quarRes] = await Promise.allSettled([
                            fetch("/.well-known/mirror-directory.json", {
                                ...
                                "useMirrorsData.useEffect.load": (r)=>r.ok ? r.json() : null
                            }["useMirrorsData.useEffect.load"]),
                        ...
                        const mirrorPromises = directory.mirrors.map({
                            "useMirrorsData.useEffect.load.mirrorPromises": async (m)=>{
                                try {
                        ...
                        }["useMirrorsData.useEffect.load.mirrorPromises"]);
                        ...
                        // Sort table
                        table.sort({
                            "useMirrorsData.useEffect.load": (a, b)=>a.mirrorId.localeCompare(b.mirrorId)
                        }["useMirrorsData.useEffect.load"]);
                        // Compute Convergence
                        const sortedBuckets = Array.from(buckets.entries()).map({
                            "useMirrorsData.useEffect.load.sortedBuckets": ([hash, ids])=>({
                                    rootHash: hash,
                                    count: ids.length,
                                    mirrorIds: ids.sort()
                                })
                        }["useMirrorsData.useEffect.load.sortedBuckets"]).sort({
                            "useMirrorsData.useEffect.load.sortedBuckets": (a, b)=>b.count - a.count || a.rootHash.localeCompare(b.rootHash)
                        }["useMirrorsData.useEffect.load.sortedBuckets"]);
                        const majorityRootHash = sortedBuckets.length > 0 ? sortedBuckets[0].rootHash : null;
                        const outlierMirrors = sortedBuckets.slice(1).flatMap({
                            "useMirrorsData.useEffect.load.outlierMirrors": (b)=>b.mirrorIds
                        }["useMirrorsData.useEffect.load.outlierMirrors"]);
                        const convergence = {
                        ...
                        // Compute Banner
                        const greenCount = table.filter({
                            "useMirrorsData.useEffect.load": (t)=>t.status === "GREEN"
                        }["useMirrorsData.useEffect.load"]).length;
                        const amberCount = table.filter({
                            "useMirrorsData.useEffect.load": (t)=>t.status === "AMBER"
                        }["useMirrorsData.useEffect.load"]).length;
                        const redCount = table.filter({
                            "useMirrorsData.useEffect.load": (t)=>t.status === "RED"
                        }["useMirrorsData.useEffect.load"]).length;
                        const unreachableCount = table.filter({
                            "useMirrorsData.useEffect.load": (t)=>t.status === "UNREACHABLE"
                        }["useMirrorsData.useEffect.load"]).length;
                        ...
                        const clusters = Array.from(clustersMap.entries()).map({
                            "useMirrorsData.useEffect.load.clusters": ([region, nodes])=>({
                                    clusterId: region,
                                    label: `Region: ${region}`,
                                    nodes: nodes.sort({
                                        "useMirrorsData.useEffect.load.clusters": (a, b)=>a.mirrorId.localeCompare(b.mirrorId)
                                    }["useMirrorsData.useEffect.load.clusters"])
                                })
                        }["useMirrorsData.useEffect.load.clusters"]).sort({
                            "useMirrorsData.useEffect.load.clusters": (a, b)=>a.clusterId.localeCompare(b.clusterId)
                        }["useMirrorsData.useEffect.load.clusters"]);
                        const mapModel = {
                            clusters,
                            legend: [
                        ...
                        if (isMounted) setState({
                            ...
                            convergence,
                            quarantinePanel: {
                                quarantinedMirrors: table.filter({
                                    "useMirrorsData.useEffect.load": (t)=>t.isQuarantined
                                }["useMirrorsData.useEffect.load"])
                            },
                            rawRefs: {
...
_s(useMirrorsData, "TCNw7y/yaKjDug+hZsPP41CfFrA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/Desktop/whenisdue/web/app/verify/mirrors/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$app$2f$verify$2f$mirrors$2f$useMirrorsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/whenisdue/web/app/verify/mirrors/useMirrorsData.ts [app-client] (ecmascript)");
...
function MirrorsNetworkPage() {
    _s();
    const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$app$2f$verify$2f$mirrors$2f$useMirrorsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMirrorsData"])();
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: map.clusters.map((cluster)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: cluster.nodes.map((node)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: map.legend.map((l)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        convergence.rootHashBuckets.map((b, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                        ...
                                                        children: table.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(MirrorsNetworkPage, "IYlFgyarrS6hjaM8cDEgCI1LVRM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$app$2f$verify$2f$mirrors$2f$useMirrorsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMirrorsData"]
    ];
});
_c = MirrorsNetworkPage;
var _c;
__turbopack_context__.k.register(_c, "MirrorsNetworkPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/Desktop/whenisdue/web/node_modules/lucide-react/dist/esm/icons/server.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Server = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("server", __iconNode);
;
 //# sourceMappingURL=server.js.map
}),
"[project]/Desktop/whenisdue/web/node_modules/lucide-react/dist/esm/icons/server.js [app-client] (ecmascript) <export default as Server>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "Server",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$whenisdue$2f$web$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$server$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
//# sourceMappingURL=Desktop_whenisdue_web_6368c22a._.js.map